...
- `torus_mesh(major_radius, minor_radius, major_segments, minor_segments)`: outward winding の quad torus を作成します。
...
- `Transform3::identity/translation/scale/compose`: identity、translation、scale、composition。
